        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-[#232323] text-center ">
            ...
            <div className="py-[90px] w-[325px]">
              ...
              <button className="w-full bg-[#C7C7C7] text-[#232323] uppercase text-[16px] px-[104px] py-[13px] font-[700] leading-[22px] tracking-[1px] " style={{fontFamily:"sohen-breit"}}> login</button>
            </div>



            <div className="uppercase ">
              <p className="text-[16px] font-[700] tracking-[-0.16px]" style={{fontFamily:"frankton-mono-bold"}}>Don’t HAVE an account?</p>
              <button className="mt-[10px] uppercase text-[16px] tracking-[1px] leading-[22px] border-b-2 font-[700]" style={{fontFamily:"sohen-breit"}}>sign up</button>
            </div>
          </div>
        </div>
      </div>
